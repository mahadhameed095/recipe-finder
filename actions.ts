...
//   // check the cache
//   // const cachedResult = await kv.get<RecipeType[]>(searchTerm + alpha.toString());

//   // return if cache-hit
//   // if (cachedResult) return cachedResult;

//   // if miss, then first get reference to the collection "Recipe" 
//   const collection = client.collections.get<RecipeType>(
//     "Recipe"
//   );

//   // Weaviate's hybrid search functionality to get top 20 most relevant recipes 
//   const { objects : recipes } = await collection.query.hybrid(searchTerm, {
//     limit: 20,
//     alpha,
//     returnMetadata: ["score", "explainScore"],
//   });

//   // store the results in cache for next usage
//   // await kv.set(
